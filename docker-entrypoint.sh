...
cat /build/app-template.js | envsubst '$$DEBUG_PARTIAL_CONVERSION $$PEGNET_API_URL $$FACTOM_EXPLORER_URL $$PUBLIC_NETWORK_GATEWAY_APP_ID $$PUBLIC_NETWORK_GATEWAY_APP_KEY $$API_URL $$API_TOKEN' > $TARGET_APP_JS
